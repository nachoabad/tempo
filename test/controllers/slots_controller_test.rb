...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { day: @slot.day, hour: @slot.hour, min: @slot.min, service_id: @slot.service_id, status: @slot.status, zone: @slot.zone } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { day: @slot.day, hour: @slot.hour, min: @slot.min, service_id: @slot.service_id, status: @slot.status, zone: @slot.zone } }
